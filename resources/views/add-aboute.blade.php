        ...
        <div class="center-block2 col-md-6">
            <div class="widget  ">
                <div class="widget-header padding-1px">
                    <h3 class="align-center margin-auto"> درباره ما </h3>
                </div>
                <div class="widget-content padding-button-auto">
                    <form method="post" action="/add/aboute" enctype="multipart/form-data">
                        <fieldset>

                            <div class="control-group">
                                <div class="col-md-3 align-right">
                                    <label class="control-label align-right" for="title">عنوان : </label>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input required class="form-control parsley-validated" name="title" id="title" type="text" value="@if(isset($aboute)) {{$aboute->title}} @endif">
                                    </div>
                                </div>
                            </div>
